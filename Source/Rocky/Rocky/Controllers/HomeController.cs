...
namespace Rocky.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                Product = _prodRepo.FirstOrDefault(filter: u => u.Id == id,  includeProperties: "Category,ApplicationType")
            };
        ...
        public IActionResult DetailsPost(int id, DetailsVM details)
        {
            ...
            shoppingCartList.Add(new ShoppingCart { ProductId = id, SqFt = details.Product.TempSqFt});
